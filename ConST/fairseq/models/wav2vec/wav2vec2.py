...
class Wav2Vec2Model(BaseFairseqModel):
    ...
    def forward(self, source, padding_mask=None, mask=True, features_only=False):
        # logger.info("In the w2v2: {}".format(source.size()))
        ...
        # logger.info("After feature extractor: {}".format(features.size()))
        ...
        # logger.info("After w2v2 encoder: {}".format(x.size()))
        if features_only:
        ...
        # logger.info("final proj: {}".format(x.size()))
